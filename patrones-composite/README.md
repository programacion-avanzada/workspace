...
El patrón de diseño Composite nos sirve para construir estructuras complejas partiendo de otras estructuras mucho más simples, dicho de otra manera, podemos crear estructuras compuestas las cuales están conformadas por otras estructuras más pequeñas. Utilizando composite, podemos tratar a la unidades complejas y a las simples de igual manera si necesidad de saber si se trata de la simple o la compuesta, dado que ambas cumplen la misma interfaz.
